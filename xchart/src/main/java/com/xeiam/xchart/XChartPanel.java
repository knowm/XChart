...
public class XChartPanel extends JPanel {
    ...
    private void showSaveAsDialog() {
        ...
        fileChooser.addChoosableFileFilter(new SuffixSaveFilter("jpeg"));
        ...
        if (fileChooser.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            if (fileChooser.getSelectedFile() != null) {
                ...
                try {
                    String filePath = theFileToSave.getCanonicalPath().toString();
                    if (fileChooser.getFileFilter() == null) {
                        ...
                        BitmapEncoder.saveBitmap(chart, filePath, BitmapFormat.BMP);
                    } else if (fileChooser.getFileFilter().getDescription().equals("*.gif,*.GIF")) {
                        BitmapEncoder.saveBitmap(chart, filePath, BitmapFormat.GIF);
                        ...
                        VectorGraphicsEncoder.saveVectorGraphic(chart, filePath, VectorGraphicsFormat.EPS);
                    } else if (fileChooser.getFileFilter().getDescription().equals("*.svg,*.SVG")) {
                        VectorGraphicsEncoder.saveVectorGraphic(chart, filePath, VectorGraphicsFormat.SVG);
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
