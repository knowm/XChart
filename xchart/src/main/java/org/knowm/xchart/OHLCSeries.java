...
public class OHLCSeries extends AxesChartSeries {
    ...
    public enum OHLCSeriesRenderStyle {

        Candle, HiLo;
    }

    private OHLCSeriesRenderStyle renderStyle;
    ...
    public OHLCSeriesRenderStyle getRenderStyle() {

        return renderStyle;
    }

    public OHLCSeries setRenderStyle(OHLCSeriesRenderStyle renderStyle) {
     ...
     * @param newCloseData
     */
    void replaceData(double[] newXData, double[] newOpenData, double[] newHighData,
