...
public class BubbleChart extends Chart<BubbleStyler, BubbleSeries> {
  ...
  public BubbleSeries addSeries(String seriesName, List<?> xData, List<? extends Number> yData, List<? extends Number> bubbleData) {
    ...
    case Date:
      ...
      return addSeries(seriesName, Utils.getDoubleArrayFromDateList(xData), Utils.getDoubleArrayFromNumberList(yData), Utils.getDoubleArrayFromNumberList(bubbleData), Series.DataType.Date);

    default:
      return addSeries(seriesName, Utils.getDoubleArrayFromNumberList(xData), Utils.getDoubleArrayFromNumberList(yData), Utils.getDoubleArrayFromNumberList(bubbleData), Series.DataType.Number);
    }
  ...
  public BubbleSeries addSeries(String seriesName, double[] xData, double[] yData, double[] bubbleData) {
    ...
    return addSeries(seriesName, xData, yData, bubbleData, DataType.Number);
  }
   ...
   * @return
   */
  private BubbleSeries addSeries(String seriesName, double[] xData, double[] yData, double[] bubbleData, Series.DataType dataType) {
    ...
    if (xData != null) {
      ...
      series = new BubbleSeries(seriesName, xData, yData, bubbleData, dataType);
    }
    else { // generate xData
      series = new BubbleSeries(seriesName, Utils.getGeneratedDataAsArray(yData.length), yData, bubbleData, dataType);
    }
