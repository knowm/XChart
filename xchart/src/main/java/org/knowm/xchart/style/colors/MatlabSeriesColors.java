...
public class MatlabSeriesColors implements SeriesColors {
  ...
  private static final Color TURQUOISE = new Color(0, 191, 191, 255);
  private static final Color MAGENTA = new Color(191, 0, 191, 255);
  private static final Color YELLOW = new Color(191, 191, 0, 255);
  private static final Color DARK_GREY = new Color(64, 64, 64, 255);
