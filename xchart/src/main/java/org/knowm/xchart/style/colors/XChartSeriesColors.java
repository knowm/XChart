...
public class XChartSeriesColors implements SeriesColors {
  ...
  private static final Color ORANGE = new Color(255, 172, 0, 180);
  ...
  private static final Color YELLOW = new Color(255, 215, 0, 180);
  private static final Color MAGENTA = new Color(255, 0, 255, 180);
  public static final Color PINK = new Color(255, 166, 201, 180);
  private static final Color LIGHT_GREY = new Color(207, 207, 207, 180);
  private static final Color CYAN = new Color(0, 255, 255, 180);
  private static final Color BROWN = new Color(102, 56, 10, 180);
  private static final Color BLACK = new Color(0, 0, 0, 180);
