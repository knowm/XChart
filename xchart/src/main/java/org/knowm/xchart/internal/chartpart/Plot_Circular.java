    ...
    public void paint(Graphics2D g) {
        ...
        double width =
                ...
                chart.getWidth()
                        ...
                        - (chart.getStyler().getLegendPosition() == Styler.LegendPosition.OutsideE ? chart.getLegend().getBounds().getWidth() : 0)

                        - 2 * chart.getStyler().getChartPadding()

                        - (chart.getStyler().getLegendPosition() == Styler.LegendPosition.OutsideE && chart.getStyler().isLegendVisible() ? chart.getStyler().getChartPadding() : 0);

        double height = chart.getHeight() - chart.getChartTitle().getBounds().getHeight()

                - (chart.getStyler().getLegendPosition() == Styler.LegendPosition.OutsideS ? chart.getLegend().getBounds().getHeight() : 0)
