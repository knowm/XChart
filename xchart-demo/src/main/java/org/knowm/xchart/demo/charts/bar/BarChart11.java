...
public class BarChart11 implements ExampleChart<CategoryChart> {
  ...
  public CategoryChart getChart() {
    ...
    // Create Chart
    CategoryChart chart = new CategoryChartBuilder().width(800).height(600).title("Tumbler Speed  vs. Average Spin").xAxisTitle("Speed").yAxisTitle("Spin").build();
    ...
    // Series
    CategorySeries series1 = chart.addSeries("Cats", getLinearValues(0, 200, 21), getRandomValues(-50, 50, 21));
    CategorySeries series2 = chart.addSeries("Hamsters", getLinearValues(0, 200, 21), getRandomValues(-50, 50, 21));
