...
public class BoxPlotChart03 implements ExampleChart<BoxPlotChart> {
  ...
  public BoxPlotChart getChart() {
    ...
    boxSeries[1] = chart.addSeries("bbb", Arrays.asList("Blue", "Red", "Green", "Yellow", "Orange"),
        Arrays.asList(20, 10, 25, null, 60));
    boxSeries[2] = chart.addSeries("ccc", Arrays.asList("Blue", "Red", "Green", "Yellow", "Orange"),
        Arrays.asList(30, 20, 22, 40, 50));
    boxSeries[3] = chart.addSeries("ddd", Arrays.asList("Blue", "Red", "Green", "Yellow", "Orange"),
        Arrays.asList(10, 15, 28, 50, 65));
    boxSeries[4] = chart.addSeries("eee", Arrays.asList("Blue", "Red", "Green", "Yellow", "Orange"),
        Arrays.asList(25, 25, 30, 30, 55));
    boxSeries[5] = chart.addSeries("fff", Arrays.asList("Blue", "Red", "Green", "Yellow", "Orange"),
        Arrays.asList(15, 18, 29, 20, 50));
    // Customize Chart
