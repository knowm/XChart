    ...
    boxSeries[0] =
        chart.addSeries(
            ...
            Arrays.asList(
                ...
                9353.79, 8224.60, 10436.48, 10399.62, 15067.39, 8505.73, 9398.87, 11611.29,
                12280.94, 9631.96));
    boxSeries[1] = chart.addSeries("bbb", Arrays.asList(7000, 8000, 9000));
    boxSeries[2] = chart.addSeries("ccc", Arrays.asList(7000, 8000, null, 9000));
