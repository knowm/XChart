 ...
 */
public class DateChart01a implements ExampleChart<XYChart> {

  public static void main(String[] args) {

    ExampleChart<XYChart> exampleChart = new DateChart01a();
  ...
  public XYChart getChart() {
    ...
    chart.setYAxisGroupTitle(0, chart.getSeriesMap().get("series 1").getName());
    chart.setYAxisGroupTitle(1, chart.getSeriesMap().get("series 2").getName());
