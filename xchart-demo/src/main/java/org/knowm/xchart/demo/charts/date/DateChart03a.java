 ...
 */
public class DateChart03a implements ExampleChart<XYChart> {

  public static void main(String[] args) {

    ExampleChart<XYChart> exampleChart = new DateChart03a();
  ...
  public XYChart getChart() {
    ...
    // series creation order (position) is critical, since `Legend` would be misleading
    chart.addSeries("series2", xData2, yData2);
    chart.addSeries("series1", xData1, yData1).setYAxisGroup(1);
    
    chart.setYAxisGroupTitle(1, "Y1");
    chart.setYAxisGroupTitle(0, "Y2");
    
    chart.setYAxisGroupTitleColor(0, chart.getStyler().getSeriesColors()[0]);
    chart.setYAxisGroupTitleColor(1, chart.getStyler().getSeriesColors()[1]);
