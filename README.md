...
```scala
libraryDependencies += "org.knowm.xchart" % "xchart" % "3.8.7" exclude("de.erichseifert.vectorgraphics2d", "VectorGraphics2D") withSources()
```
...
- Linux: execute command `java -cp xchart-demo-3.8.7.jar:xchart-3.8.7.jar org.knowm.xchart.demo.XChartDemo`.

- Windows: In the cmd command window, execute the command `java -cp xchart-demo-3.8.7.jar;xchart-3.8.7.jar org.knowm.xchart.demo.XChartDemo`; In 
  the PowerShell command window, execute the command `java -cp "xchart-demo-3.8.7.jar;xchart-3.8.7.jar" org.knowm.xchart.demo.XChartDemo`.

E.g:
```sh
cd /path/to/xchart-demo/jar/
java -cp xchart-demo-3.8.7.jar:xchart-3.8.7.jar org.knowm.xchart.demo.XChartDemo
```
